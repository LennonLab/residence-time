...
def output(iD, sD, rD, ps, sim, t, ct, prod, splist2, asplist2, dsplist2, D, minlim, pD, clr, Ri):
    ...
    OUT = open('results/simulated_data/SimData.csv', 'a')
    ...
    OUT = open('results/simulated_data/RAD-Data.csv', 'a')
    print>>OUT, sim, ',', h/u, ',', ct,',',  RAD, ',', splist
    OUT.close()

    OUT = open('results/simulated_data/active.RAD-Data.csv', 'a')
    print>>OUT, sim, ',', h/u, ',', ct,',',  aRAD, ',', asplist
    OUT.close()

    OUT = open('results/simulated_data/dormant.RAD-Data.csv', 'a')
...
def clear():
    OUT = open('results/simulated_data/RAD-Data.csv', 'w+').close()
    OUT = open('results/simulated_data/active.RAD-Data.csv', 'w+').close()
    OUT = open('results/simulated_data/dormant.RAD-Data.csv', 'w+').close()
    OUT = open('results/simulated_data/SimData.csv','w+')
