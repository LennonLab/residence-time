...
df2['Prod'] = np.log10(df['ind.production'])
...
df3 = df2[df2['N'] > 1.0]
plt.hexbin(df3['tau'], df3['N'], mincnt=mnct, gridsize = gd, bins=binz, cmap=plt.cm.jet)
...
df3 = df2[df2['Prod'] > 0]
plt.hexbin(df3['tau'], df3['Prod'], mincnt=mnct, gridsize = gd, bins=binz, cmap=plt.cm.jet)
...
plt.hexbin(df3['tau'], df3['W'], mincnt=mnct, gridsize = gd, bins=binz, cmap=plt.cm.jet)
