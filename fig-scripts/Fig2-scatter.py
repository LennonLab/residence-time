...
f2 = smf.ols('N ~ tau + I(tau ** 2.0)', dat).fit()
print f2.summary()
...
tau3, fitted, pred_ci_low, pred_ci_upp, pred_mean_ci_low, pred_mean_ci_upp = zip(*sorted(zip(tau, fitted, pred_ci_low, pred_ci_upp, pred_mean_ci_low, pred_mean_ci_upp)))
...
f2 = smf.ols('S ~ tau + I(tau ** 2.0)', dat).fit()
#print f2.summary()
a, b, c =  f2.params
p1, p2, p3 = f2.pvalues
r2 = round(f2.rsquared, 2)
...
plt.scatter(tau, S, color = 'b', alpha= 0.4 , s = 5, linewidths=0.0, edgecolor='k')
...
f2 = smf.ols('E ~ tau + I(tau ** 2.0)', dat).fit()
#print f2.summary()
a, b, c =  f2.params
p1, p2, p3 = f2.pvalues
r2 = round(f2.rsquared, 2)
...
plt.scatter(tau, E, color = 'b', alpha= 0.4 , s = 5, linewidths=0.0, edgecolor='k')
...
plt.scatter(tau, W, color = 'b', alpha= 0.4 , s = 5, linewidths=0.0, edgecolor='k')
...
plt.savefig(mydir + '/results/figures/Fig2-scatter.png', dpi=600, bbox_inches = "tight")
#plt.show()
